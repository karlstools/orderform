 ...
 * Select Materials
   ...
   * Use the Category buttons (e.g., Equipment, Fiber/Copper) to filter the grid.
   * Use the + and - buttons on the item cards to set the desired quantity. The running Total Items count is displayed in the footer.
 * Review and Download
